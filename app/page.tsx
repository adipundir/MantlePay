...
import { ArrowRight, Code, Globe, Webhook, LayoutDashboard } from "lucide-react"
    ...
    <main className="overflow-x-hidden">
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            <div className="flex flex-col justify-center space-y-6">
              ...
              <div className="flex flex-col w-full sm:flex-row gap-4">
                <ScrollToSection targetId="waitlist" className="w-full sm:w-auto" centerInViewport={true}>
                  <Button size="lg" className="w-full gap-1 btn-mobile-full">
                    Join Waitlist <ArrowRight className="h-4 w-4 ml-1" />
                  </Button>
                </ScrollToSection>
                <Link href="/docs" className="w-full sm:w-auto">
                  <Button size="lg" variant="outline" className="w-full btn-mobile-full">
                    View Docs
                  </Button>
                </Link>
              </div>
        ...
        <div className="container">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-3">
              <h2 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl lg:text-5xl">Developer-First Features</h2>
      ...
      <section id="how-it-works" className="w-full py-12 md:py-24 lg:py-32">
        <div className="container">
          ...
          <div className="mx-auto grid max-w-5xl items-start gap-8 py-10 md:grid-cols-3 md:gap-12">
      ...
      {/* Waitlist Section */}
      <section 
        className="w-full min-h-[90vh] flex items-center justify-center py-28 md:py-32 lg:py-36 relative overflow-hidden"
      ...
      >
        ...
        <div className="container relative z-10">
          <div className="flex flex-col items-center justify-center space-y-8 text-center max-w-3xl mx-auto">
            ...
            <div id="waitlist"  className="w-full bg-card border border-border/60 rounded-xl shadow-lg p-6 md:p-8">
              <WaitlistForm />
            </div>
          </div>
        </div>
